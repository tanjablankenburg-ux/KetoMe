...
export const REZEPTE: Rezept[] = [
...

  {
    ...
    zubereitung: [
      ...
      "30 Sekunden auf höchster Stufe mixen bis cremig-schaumig.",
  ...
  },
  {
    ...
    zubereitung: [
      ...
      "Butter in Pfanne bei mittlerer Hitze schmelzen.",
      "Eimasse eingießen und stocken lassen.",
  ...
  },
  {
    ...
    zubereitung: [
      ...
      "Eier daneben anrichten und genießen.",
    ],
  },
  {
    id: "chia-pudding",
  ...
  },
  {
    ...
    zubereitung: [
      ...
      "Butter in Pfanne bei mittlerer Hitze schmelzen.",
      "Kleine Häufchen Teig einlöffeln und leicht flach drücken.",
  ...
  },
  {
    ...
    zubereitung: [
      "Speck knusprig braten, beiseitelegen.",
      "Eier mit Sahne, Salz und Pfeffer verquirlen.",
      "Butter bei niedriger Hitze schmelzen, Eimasse eingießen.",
      "Mit Spatel langsam von außen nach innen schieben bis cremig gestockt.",
      "Mit Speck und Schnittlauch servieren.",
    ],
  },
  {
    ...
    zubereitung: [
      "Frischkäse mit Dill und Zitronensaft verrühren.",
      "Je einen EL Frischkäse auf eine Lachsscheibe geben.",
      "Fest aufrollen und ggf. mit Zahnstocher fixieren.",
      "Mit Gurkenscheiben anrichten.",
    ],
  },
  {
    ...
    zubereitung: [
      "Kokosmilch in kleinem Topf leicht erhitzen.",
      "Kokosmehl einrühren und 2 Min quellen lassen.",
      "Ei einrühren und bei niedriger Hitze dicklich rühren.",
      "Butter, Stevia und Zimt unterrühren.",
  ...
  },
  {
    ...
    zubereitung: [
      ...
      "Walnüsse grob hacken und drüber streuen.",
      "Beeren und Chiasamen obenauf.",
      "Mit Stevia süßen nach Wunsch.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Olivenöl erhitzen, Spinat kurz zusammenfallen lassen.",
      "Eimasse drübergießen, bei mittlerer Hitze stocken.",
      "Feta drüber krümeln, zusammenfalten.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Avocado halbieren, Kern entfernen — Mulde etwas vergrößern.",
      "Je ein Ei in die Mulde geben, würzen.",
      "Bacon rundherum legen.",
      "15–18 Min backen bis Ei gestockt.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Ca. 30 Sekunden mixen bis cremig.",
      "Mit Eis servieren.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Muffinform fetten oder Silikonform verwenden.",
      "Speck, Paprika und Käse auf die Mulden verteilen.",
      "Eier darüber aufschlagen oder verquirlt eingießen.",
      "20 Min backen. Hält 4 Tage im Kühlschrank.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Alle Zutaten zu glattem Teig verrühren.",
      "Teig ins Waffeleisen geben, 4–5 Min backen.",
  ...
  },
  {
    ...
    zubereitung: [
      "Quark mit Sahne cremig rühren.",
      "Mit Stevia und Zimt abschmecken.",
      "Nüsse und Beeren drüber geben.",
    ],
  },
  {
    ...
    zubereitung: [
      "Eier und Frischkäse cremig mixen.",
      "Butter in Pfanne schmelzen.",
      "Dünne Pfannkuchen bei kleiner Hitze backen (je 2 Min).",
      "Mit Beeren oder Frischkäse füllen.",
    ],
  },
  {
    id: "schinken-ei-wrap",
    ...
    zubereitung: [
      "Rührei mit Käse zubereiten.",
      "Schinkenscheiben überlappend auslegen.",
      "Rührei, Senf und Rucola darauf verteilen.",
  ...
  },
  {
    ...
    zubereitung: [
      "Sellerie waschen und in handliche Stücke schneiden.",
      "Mandelbutter drauflöffeln.",
  ...
  },
  {
    ...
    zubereitung: [
      "Gurke mit Sparschäler in lange dünne Streifen schneiden.",
      "Frischkäse mit Dill und Zitrone würzen.",
      "Frischkäse und Lachs auf Gurkensstreifen legen.",
  ...
  },
  {
    ...
    zubereitung: [
      ...
      "Alle Zutaten mit Kokosöl und Stevia mischen.",
      "Auf Backblech verteilen, 15–18 Min goldbraun rösten.",
      "Auskühlen lassen — wird beim Abkühlen knusprig.",
      "In Glas füllen, hält 2 Wochen.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Speck in Pfanne knusprig braten.",
      "Halloumi im Speckfett je 2 Min braten bis goldbraun.",
      "Mit Paprika und Thymian servieren.",
    ],
  },
  {
    id: "eier-im-nest",
    ...
    zubereitung: [
      ...
      "Speckscheiben in Muffinmulden zu Nestern formen.",
      "Je ein Ei hineinschlagen, Käse drüber.",
      "12–15 Min backen bis Ei gestockt.",
    ],
  },
  {
    ...
    zubereitung: [
      "Kokosbutter schmelzen, alle Zutaten vermischen.",
      "In rechteckige Form (mit Backpapier) pressen.",
      "Geschmolzene Schokolade drüber träufeln.",
      "1 h kühlen, dann in Riegel schneiden.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Zucchini reiben, kräftig ausdrücken.",
      "Mit Frischkäse, Eiern, Mandelmehl und Backpulver mischen.",
      "In Kastenform füllen, Kerne obenauf.",
      "40 Min backen, komplett auskühlen.",
    ],
  },
  {
    id: "keto-rührei-pilze",
    ...
    zubereitung: [
      "Pilze in Scheiben schneiden, in Butter 4 Min braten.",
      "Eier verquirlen, drübergießen.",
      "Sanft rühren bis cremig gestockt.",
      "Parmesan drüber hobeln, mit Thymian servieren.",
    ],
  },
  {
    ...
    zubereitung: [
      "Crème fraîche mit Stevia verrühren.",
      "Beeren drüber geben.",
      "Pecannüsse grob hacken und darüber streuen.",
  ...
  },
  {
    ...
    zubereitung: [
      "Chiasamen mit Kokosmilch, Mandeldrink, Stevia und Vanille mischen.",
      "Abgedeckt über Nacht kühlen.",
      "Morgens mit Mandelblättchen und Beeren toppen.",
    ],
  },
  {
    id: "thunfisch-frühstückssalat",
    ...
    zubereitung: [
      "Thunfisch abtropfen und mit Mayo vermengen.",
      "Gurke, Kapern und Dill unterheben.",
      "Mit Zitronensaft abschmecken.",
      "Auf Salat anrichten.",
    ],
  },

  // ─── MITTAGESSEN (31 Rezepte) ─────────────────────────────────────────────
  ...
  },
  {
    ...
    zutaten: ["1 kleiner Blumenkohl", "3 Eier", "100 g Champions", "2 EL Sojasoße (oder Kokosaminosäuren)", "2 EL Sesamöl", "Frühlingszwiebeln", "Ingwer"],
    zubereitung: [
      "Blumenkohl im Mixer zu Reis-Größe zerkleinern.",
  ...
  },
  {
    ...
    zubereitung: [
      ...
      "Feta in Würfel schneiden oder als Block.",
      "Alles in Schale geben, Oliven dazu.",
      "Großzügig Olivenöl, Oregano und Salz.",
    ],
  },
  {
    ...
    zutaten: ["400 g Rinderhack", "2 Paprika (rot, gelb)", "1 Zwiebel", "2 Zehen Knoblauch", "Tomatenmark (1 EL)", "Paprikapulver geräuchert", "Olivenöl"],
    zubereitung: [
      "Zwiebel und Knoblauch in Öl anschwitzen.",
      "Hack dazugeben und krümelig braten.",
      "Paprika in Streifen dazu, 5 Min mitbraten.",
  ...
  },
  {
    ...
    zubereitung: [
      "Lachs würzen und 4 Min je Seite braten (oder Räucherlachs direkt verwenden).",
      "Avocado in Scheiben schneiden.",
      "Salat mit Zitronenvinaigrette anmachen.",
      "Lachs und Avocado drauflegen, mit Dill garnieren.",
    ],
  },
  {
    id: "zucchini-suppe",
    ...
    zutaten: ["3 Zucchini", "1 Zwiebel", "500 ml Gemüsebrühe", "100 ml Sahne", "2 EL Butter", "Knoblauch", "Salz, Pfeffer", "Basilikum"],
    zubereitung: [
      "Zwiebel und Knoblauch in Butter anschwitzen.",
      "Zucchini in Stücke schneiden, dazu.",
      "Mit Brühe aufgießen, 10 Min köcheln.",
      "Pürieren, Sahne einrühren, abschmecken.",
    ],
  },
  {
    ...
    zubereitung: [
      "Gurke in Scheiben, mit Dill, Joghurt, Zitrone und Olivenöl verrühren.",
      "Pute in Streifen würzen und scharf anbraten.",
      "Heiß auf kaltem Gurkensalat servieren.",
    ],
  },
  {
    ...
    zubereitung: [
      "Garnelen mit Knoblauch, Chili, Salz in Öl 3 Min braten.",
      "Avocado in Scheiben schneiden.",
      "Rucola und Tomaten in Schüssel legen.",
      "Garnelen und Avocado drauflegen, Zitrone drüber.",
    ],
  },
  {
    ...
    zubereitung: [
      "Pilze in Scheiben in Butter braten.",
      "Knoblauch dazu, Spinat zusammenfallen lassen.",
      "Mulden formen, Eier hineinschlagen.",
      "Deckel drauf, 5 Min pochieren.",
      "Mit Parmesan und Muskat servieren.",
    ],
  },
  {
    id: "blumenkohl-suppe",
    ...
    zutaten: ["1 Blumenkohl", "1 Zwiebel", "600 ml Hühnerbrühe", "150 ml Sahne", "2 EL Butter", "Muskat", "Salz, Pfeffer", "Schnittlauch"],
    zubereitung: [
      "Zwiebel in Butter anschwitzen.",
      "Blumenkohl in Röschen dazu, kurz mitbraten.",
      "Brühe angießen, 15 Min kochen.",
      "Pürieren, Sahne einrühren.",
      "Mit Muskat und Schnittlauch abschmecken.",
    ],
  },
  {
    ...
    zubereitung: [
      "Ofen auf 200 °C vorheizen.",
      "Zucchini halbieren, Fruchtfleisch aushöhlen.",
      "Hack mit Zwiebel, Knoblauch, Tomatenmark braten.",
      "Zucchini füllen, Käse drüber.",
      "20 Min überbacken.",
    ],
  },
  {
    id: "haehnchen-kräuterquark",
    ...
    zutaten: ["300 g Hähnchenbrust", "150 g Quark", "2 EL Sahne", "Kräuter (Dill, Petersilie, Schnittlauch)", "Zitrone", "Gemischter Salat"],
    zubereitung: [
      "Hähnchen in Streifen würzen und braten.",
      "Quark mit Sahne, Kräutern und Zitrone verrühren.",
      "Auf Salat anrichten, Quark dazu.",
    ],
  },
  {
    id: "eiersalat-keto",
    ...
    bild: "🥚",
    tags: ["keto", "eier", "kalt"],
    zutaten: ["4 Eier (hartgekocht)", "3 EL Mayonnaise", "1 TL Senf", "Schnittlauch", "Salz, Pfeffer", "Paprikapulver", "Salat"],
    zubereitung: [
      "Eier in kaltem Wasser 8 Min kochen, schälen und hacken.",
      "Mit Mayo, Senf und Gewürzen mischen.",
      "Auf Salat oder Gurkenscheiben servieren.",
    ],
  },
  {
    id: "makrele-salat",
    ...
    zubereitung: [
      "Makrele abtropfen, grob zerpflücken.",
      "Avocado würfeln, Zwiebel in Ringe schneiden.",
      "Salat mit Vinaigrette anmachen.",
      "Makrele und Avocado drauflegen.",
    ],
  },
  {
    id: "wrap-salatblatt",
    ...
    zutaten: ["200 g Hähnchenbrust", "8 große Salatblätter", "½ Avocado", "Kirschtomaten", "Sriracha oder Senf (zuckerfrei)", "Sesam"],
    zubereitung: [
      "Hähnchen würzen, braten und in Streifen schneiden.",
      "Avocado und Tomaten vorbereiten.",
      "Alles in Salatblätter wickeln.",
      "Mit Sauce und Sesam toppen.",
    ],
  },
  {
    id: "sardinen-salat",
    ...
    zubereitung: [
      "Sardinen abtropfen.",
      "Tomaten halbieren, Zwiebel in feine Ringe schneiden.",
      "Alles auf Rucola anrichten.",
      "Mit Kapern, Zitrone und Olivenöl fertigstellen.",
    ],
  },
  {
    id: "keto-burger-bowl",
    ...
    zubereitung: [
      "Hackfleischpattys formen, würzen und braten.",
      "Käse auf Patty schmelzen.",
      "Salat, Tomaten, Gurken in Schale.",
      "Patty drauf, Mayo und Senf drüber.",
    ],
  },
  {
    ...
    zubereitung: [
      "Lachs fein hacken, mit Frischkäse, Dill, Zitrone vermischen.",
      "Gurke in Scheiben schneiden.",
      "Lachscreme auf Gurken löffeln.",
    ],
  },
  {
    ...
    zubereitung: [
      "Spargel in Salzwasser 5 Min kochen.",
      "Abschrecken, in Stücke schneiden.",
      "Mit Salat und Schinken anrichten.",
      "Parmesan darüberhobeln, Vinaigrette drüber.",
    ],
  },
  {
    ...
    zutaten: ["2 Hähnchenbrüste", "Feldsalat", "Gurke", "3 EL Olivenöl", "1 EL Dijonsenf", "1 EL Zitronensaft", "Salz, Pfeffer"],
    zubereitung: [
      "Hähnchen würzen, 8 Min je Seite braten.",
      "Dressing: Olivenöl, Senf, Zitrone, Salz mischen.",
      "Salat und Gurken mit Dressing anmachen.",
      "Hähnchen in Scheiben drauflegen.",
    ],
  },
  {
    id: "lauchsuppe",
    ...
    zutaten: ["2 Lauchstangen", "100 g Speck", "500 ml Hühnerbrühe", "150 ml Sahne", "2 EL Butter", "Muskat", "Salz, Pfeffer"],
    zubereitung: [
      "Speck würfeln und knusprig braten.",
      "Lauch in Ringe schneiden, in Butter anschwitzen.",
      "Brühe angießen, 15 Min köcheln.",
      "Sahne einrühren, pürieren oder rustikal lassen.",
      "Mit Speck toppen.",
    ],
  },
  {
    ...
    zutaten: ["200 g Halloumi", "Rucola", "Kirschtomaten", "Gurke", "Oliven", "Olivenöl", "Zitrone", "Minze optional"],
    zubereitung: [
      "Halloumi in Scheiben in Pfanne ohne Fett je 2 Min braten.",
      "Gemüse und Salat anrichten.",
      "Halloumi drauflegen.",
  ...
  },
  {
    ...
    zutaten: ["300 g Rinderhack", "Eisbergsalat", "1 Avocado", "50 g Cheddar", "Saure Sahne", "Salsa (zuckerfrei)", "Kreuzkümmel, Paprika"],
    zubereitung: [
      "Hack mit Kreuzkümmel, Paprika, Salz braten.",
      "Salat als Boden in Schale legen.",
      "Hack, gewürfelte Avocado und Käse drauf.",
      "Saure Sahne und Salsa obenauf.",
    ],
  },
  {
    ...
    zutaten: ["400 g Brokkoli", "150 g Cheddar gerieben", "500 ml Hühnerbrühe", "200 ml Sahne", "1 Zwiebel", "2 EL Butter", "Salz, Pfeffer"],
    zubereitung: [
      "Zwiebel in Butter anschwitzen.",
      "Brokkoli in Röschen dazu, 3 Min mitbraten.",
      "Brühe und Sahne angießen, 12 Min köcheln.",
      "Hälfte pürieren, Cheddar einrühren.",
    ],
  },
  {
    ...
    bild: "🫑",
    tags: ["keto", "pute", "leicht"],
    zutaten: ["300 g Putenbrust", "2 Zucchini", "1 Paprika", "Olivenöl", "Provencéer Kräuter", "Knoblauch", "Salz, Pfeffer"],
    zubereitung: [
      "Pute würzen, 6 Min je Seite braten.",
      "Zucchini und Paprika in Streifen 5 Min mitbraten.",
      "Mit Kräutern und Knoblauch abschmecken.",
    ],
  },
  {
    ...
    zubereitung: [
      "Ofen auf 200 °C vorheizen.",
      "Mandelmehl, Eier und Parmesan zu Teig vermengen.",
      "Auf Backpapier rund ausrollen (5 mm).",
      "15 Min vorbacken.",
      "Mit Tomatenmark, Mozzarella und Belag 10 Min überbacken.",
    ],
  },
  {
    ...
    zubereitung: [
      "Brokkoli in kleine Röschen schneiden, kurz blanchieren.",
      "Speck knusprig braten.",
      "Mayo, Essig, Stevia zu Dressing verrühren.",
      "Alles mischen und mindestens 30 Min ziehen lassen.",
    ],
  },

  // ─── ABENDESSEN (31 Rezepte) ─────────────────────────────────────────────

  {
    ...
    zutaten: ["200 g Lachsfilet", "2 Zucchini", "2 EL Olivenöl", "2 Zehen Knoblauch", "Salz, Pfeffer", "Zitrone", "frischer Dill"],
    zubereitung: [
      "Zucchini mit Sparschäler oder Spiralschneider zu Nudeln schneiden.",
      "Lachs würzen und 4 Min je Seite braten.",
      "Knoblauch in Öl anschwitzen, Zucchini 2 Min mitbraten.",
  ...
  },
  {
    ...
    zutaten: ["300 g Ribeye Steak", "2 EL Butter", "Frischer Thymian, Rosmarin", "1 Zehe Knoblauch", "Meersalz, schwarzer Pfeffer"],
    zubereitung: [
  ...
  },
  {
    ...
    zubereitung: [
      ...
      "Butter schmelzen, Knoblauch anschwitzen.",
      "Garnelen 2–3 Min je Seite braten.",
      "Zitronensaft und Petersilie dazu, auf Salat servieren.",
    ],
  },
  {
    id: "keto-curry",
  ...
  },
  {
    ...
    zubereitung: [
      "Koteletts würzen, mit Kräutern einreiben.",
      "In heißer Pfanne je 3 Min braten.",
      "Rosenkohl halbieren, in Butter 10 Min braten.",
  ...
  },
  {
    ...
    bild: "🍄",
    tags: ["keto", "hack", "schnell"],
    zutaten: ["400 g Rinderhack", "300 g Champions", "1 Zwiebel", "2 EL Butter", "Sahne optional", "Petersilie", "Salz, Pfeffer, Paprika"],
    zubereitung: [
      "Zwiebel in Butter anschwitzen.",
      "Hack dazugeben, krümelig braten.",
      "Pilze dazu, 5 Min mitbraten.",
      "Würzen, optional Sahne einkochen.",
  ...
  },
  {
    ...
    zubereitung: [
      "Filet würzen, rundum anbraten.",
      "Bei 180 °C ca. 15 Min im Ofen garen.",
      "Spargel 5–7 Min kochen.",
  ...
  },
  {
    ...
    zubereitung: [
      "Ofen auf 180 °C vorheizen.",
      "Zucchini längs in Scheiben schneiden, kurz anrösten.",
      "Ricotta mit Eiern und Gewürzen mischen.",
  ...
  },
  {
    ...
    zutaten: ["2 Schweinekoteletts", "300 g grüne Bohnen", "3 EL Butter", "Knoblauch", "Thymian", "Speck optional"],
    zubereitung: [
      "Koteletts würzen, je 5 Min braten.",
      "Bohnen in Salzwasser 5 Min kochen.",
      "In Butter mit Knoblauch und Thymian schwenken.",
    ],
  },
  {
    ...
    zutaten: ["200 g Lachsfilet", "400 g grüner Spargel", "3 EL Olivenöl", "Zitronenscheiben", "Dill", "Knoblauch", "Salz, Pfeffer"],
    zubereitung: [
      "Ofen auf 200 °C vorheizen.",
      "Spargel auf Backblech, Lachs daneben legen.",
      "Olivenöl, Knoblauch und Zitrone drüber.",
      "20 Min backen.",
    ],
  },
  {
    ...
    zutaten: ["1 Entenbrust", "300 g Rotkohl", "2 EL Apfelessig", "1 EL Olivenöl", "Stevia", "Salz", "Kümmel"],
    zubereitung: [
      "Entenbrust Haut einritzen, mit Salz würzen.",
      "Hautseite unten in kalte Pfanne, 12 Min braten.",
      "Wenden, 5 Min weiter, dann 5 Min ruhen.",
      "Rotkohl fein hobeln, mit Essig, Öl, Stevia, Kümmel marinieren.",
    ],
  },
  {
    ...
    zutaten: ["300 g Putenbrust", "300 g Champions", "200 ml Sahne", "1 Schalotte", "2 EL Butter", "Thymian", "Petersilie", "Salz, Pfeffer"],
    zubereitung: [
      "Pute würzen, braten, beiseitelegen.",
      "Schalotte und Pilze in Butter braten.",
      "Sahne angießen, einkochen.",
      "Pute zurück, Thymian und Petersilie dazu.",
    ],
  },
  {
    ...
    zubereitung: [
      "Zwiebel und Knoblauch in Öl anschwitzen.",
      "Hack anbraten, Tomaten dazugeben.",
      "20 Min köcheln lassen, würzen.",
      "Zucchini-Nudeln kurz braten.",
  ...
  },
  {
    ...
    zubereitung: [
      ...
      "Schweinebauch-Haut einritzen, salzen.",
      "1,5 h bei 160 °C garen, dann 15 Min bei 240 °C knusprig.",
      "Brokkoli in Butter mit Knoblauch braten.",
    ],
  },
  {
    id: "fisch-gruene-bohnen",
    ...
    zubereitung: [
      "Ofen auf 200 °C vorheizen.",
      "Kräuter, Mandelmehl und Butter zu Paste mischen.",
      "Fisch würzen, Paste obendrauf.",
  ...
  },
  {
    ...
    zubereitung: [
      "Ofen auf 180 °C vorheizen.",
      "Hähnchen und Gemüse in Auflaufform.",
      "Sahne mit Knoblauch und Kräutern darübergießen.",
      "Käse drüber, 35 Min backen.",
    ],
  },
  {
    ...
    zubereitung: [
      "Knoblauch und Ingwer in Öl anschwitzen.",
      "Currypaste kurz mitrösten.",
      "Kokosmilch eingießen, 5 Min köcheln.",
      "Garnelen und Spinat dazu, 3 Min garen.",
      "Mit Limette und Koriander servieren.",
    ],
  },
  {
    id: "keto-schnitzel",
    ...
    zubereitung: [
      ...
      "In Mandelmehl wenden, andrücken.",
      "In heißem Öl 3 Min je Seite braten.",
    ],
  },
  {
    ...
    zutaten: ["300 g Rinderstreifen", "300 g Brokkoli", "3 EL Sojasoße (oder Kokosaminosäuren)", "1 EL Sesamöl", "Knoblauch", "Ingwer", "Sesam"],
    zubereitung: [
      "Rinderstreifen scharf 2 Min braten, beiseitelegen.",
      "Brokkoli, Knoblauch, Ingwer im Wok 4 Min braten.",
      "Fleisch zurück, Sojasoße drüber.",
      "Mit Sesam servieren.",
    ],
  },
  {
    ...
    zubereitung: [
      "Hack mit Ei, Parmesan, Knoblauch, Oregano zu Bällchen formen.",
      "In Öl rundum braten.",
  ...
  },
  {
    ...
    zubereitung: [
      "Forelle würzen, in 2 EL Butter 4 Min je Seite braten.",
      "Restliche Butter bräunen, Zitronensaft und Kapern dazu.",
      "Butter-Soße über Fisch gießen.",
  ...
  },
  {
    ...
    zutaten: ["2 Hähnchenbrüste", "200 g Feta", "Kirschtomaten", "Olivenöl", "Knoblauch", "Oregano", "Basilikum", "Salz, Pfeffer"],
    zubereitung: [
      "Ofen auf 200 °C vorheizen.",
      "Hähnchen in Auflaufform legen.",
      "Tomaten und Feta-Stücke drumherum verteilen.",
      "Mit Olivenöl, Knoblauch und Kräutern übergießen.",
      "25–30 Min backen.",
    ],
  },
  {
    ...
    zubereitung: [
      "Zwiebel und Knoblauch in Öl anschwitzen.",
      "Lammhack braten, mit Kreuzkümmel würzen.",
      "Spinat unterrühren, zusammenfallen lassen.",
      "Feta drüber krümeln, kurz warm werden lassen.",
    ],
  },
  {
    ...
    zubereitung: [
      "Hähnchen in Streifen scharf anbraten.",
      "Gemüse dazu, alles scharf braten.",
      "Sojasoße, Ingwer und Knoblauch einrühren.",
      "Mit Sesam bestreuen.",
    ],
  },
  {
    id: "rindersteak-kraeuter",
    name: "Rindersteak mit Kräuterkruste und Spinatsalat",
    kategorie: "Abendessen",
    kcal: 510, kh: 3, eiweiss: 44, fett: 35,
    zeit: "20 Min", schwierigkeit: "Mittel",
    bild: "🥩",
    tags: ["keto", "steak", "kräuter"],
    zutaten: ["300 g Rindersteak", "Petersilie, Rosmarin, Thymian", "2 EL Butter", "Babyspinat", "Kirschtomaten", "Zitronenöl-Dressing"],
    zubereitung: [
      "Kräuter hacken und mit Butter vermischen.",
      "Steak würzen, scharf braten, 5 Min ruhen.",
      "Kräuterbutter auf heißes Steak legen.",
      "Spinat und Tomaten mit Dressing als Beilage.",
    ],
  },
  {
    id: "keto-frittata",
    ...
    zubereitung: [
      "Ofen auf 180 °C vorheizen.",
      "Gemüse in ofenfester Pfanne 5 Min anbraten.",
      "Verquirlte Eier drübergießen, Feta und Parmesan drüber.",
      "Auf Herd stocken lassen, dann 10 Min im Ofen fertig backen.",
    ],
  },
  {
    id: "keto-saltimbocca",
    name: "Keto-Saltimbocca (Hähnchen statt Kalb)",
    kategorie: "Abendessen",
    ...
    zubereitung: [
      "Hähnchen dünn klopfen, mit Salbei und Prosciutto belegen.",
      "In Butter von beiden Seiten 4 Min braten.",
      "Weißwein angießen, kurz einkochen.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Thunfisch, Sahne, Eier, Knoblauch verrühren.",
      "Brokkoli und Masse in Auflaufform, Käse drüber.",
      "25 Min überbacken.",
    ],
  },
  ...
  },
  {
    ...
    zutaten: ["200 g Mandelmehl", "4 Eier", "50 g Butter geschmolzen", "1 Päckchen Backpulver", "Salz", "Sesam oben"],
    zubereitung: [
      "Ofen auf 180 °C vorheizen.",
      "Alle Zutaten gut vermengen.",
      "In gefettete Kastenform füllen.",
      "40–45 Min backen, auskühlen lassen.",
    ],
  },
  {
    id: "kaese-chips",
    ...
    zubereitung: [
      "Ofen auf 200 °C vorheizen.",
      "Kleinen Häufchen Käse auf Backpapier setzen.",
      "7–8 Min backen bis goldbraun.",
      "Auskühlen lassen — werden knusprig.",
    ],
  },
  {
    id: "avocado-dip",
    ...
    zubereitung: [
      "Avocados zerdrücken.",
      "Limettensaft, Zwiebel, Chili und Koriander untermengen.",
      "Mit Salz abschmecken.",
      "Mit Sellerie-Sticks servieren.",
    ],
  },
  {
    id: "beef-jerky",
    ...
    zubereitung: [
      "Fleisch in 5 mm dünne Streifen schneiden.",
      "In Marinade mind. 4 h einlegen.",
      "Im Ofen bei 70 °C (Umluft) auf Rost 5–6 h trocknen.",
  ...
  },
  {
    ...
    zubereitung: [
      "Eier 10 Min hartkochen, schälen.",
      "Halbieren, Dotter herauslösen.",
      "Dotter mit Mayo, Senf, Salz, Pfeffer cremig rühren.",
      "In Eiweiß-Hälften spritzen oder löffeln.",
      "Mit Paprika und Schnittlauch garnieren.",
    ],
  },
  {
    ...
    zubereitung: [
      "Pilzstiele entfernen, Frischkäse einige hineinfüllen.",
      "Jeden Pilz mit halbem Bacon-Streifen umwickeln.",
      "Im Ofen bei 200 °C 15 Min backen.",
    ],
  },
  {
    id: "nut-mix-keto",
    ...
    zubereitung: [
      "Butter schmelzen, Nüsse dazu.",
      "Mit Rosmarin, Salz und Cayenne mischen.",
      "In Pfanne 5 Min rösten.",
      "Auskühlen lassen.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Zu walnussgroßen Bällchen formen.",
  ...
  },
  {
    ...
    zutaten: ["100 g dunkle Schokolade 90 %", "2 EL Kokosöl", "Stevia", "optional: Meersalz, Chili, Nüsse"],
    zubereitung: [
      "Schokolade mit Kokosöl im Wasserbad schmelzen.",
      "Stevia einrühren.",
      "In Pralinenform oder Eiswürfelform gießen.",
      "Optional Nüsse oder Meersalz drüber.",
      "1 h kühlen.",
    ],
  },
  {
  ...
  },
  {
    ...
    zubereitung: [
      "Alle Zutaten vermengen bis knetbar.",
      "Bei Bedarf etwas mehr Mandelmehl.",
      "Zu Bällchen formen.",
  ...
  },
  {
    ...
    zubereitung: [
      "Alles auf einem Brett oder Teller anrichten.",
  ...
  },
  {
    ...
    zubereitung: [
      "Gurke in Scheiben schneiden.",
      "Frischkäse draufstreichen.",
      "Mit Dill und Paprika garnieren.",
    ],
  },
  {
    ...
    zubereitung: [
      "Ofen auf 180 °C vorheizen.",
      "Mandeln mit Kokosöl, Zimt und Stevia mischen.",
      "10 Min rösten, abkühlen lassen.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "In Mini-Muffinform füllen.",
      "20 Min backen, dann 1 h kühlen.",
    ],
  },
  {
    ...
    zubereitung: [
      ...
      "Avocadowürfel in Speck einrollen.",
      "Mit Meersalz und Limette.",
    ],
  },
  {
    id: "keto-cookies",
    ...
    zubereitung: [
      ...
      "Zu Bällchen formen, flach drücken.",
      "12–14 Min goldbraun backen.",
    ],
  },
  {
    ...
    bild: "🥜",
    tags: ["keto", "einfach", "schnell"],
    zutaten: ["12 Walnusshälften", "80 g Frischkäse", "Honig-Ersatz (Stevia + Vanille)", "Meersalz"],
    zubereitung: [
      "Frischkäse mit Stevia und Vanille verrühren.",
      "Je ein TL Frischkäse zwischen zwei Walnusshälften setzen.",
      "Mit Meersalz bestreuen.",
    ],
  },
  {
    ...
    zubereitung: [
      "Mascarpone mit Sahne, Stevia und Vanille cremig rühren.",
      "Beeren in Glas geben, Creme drüber.",
      "Mit Minze garnieren.",
    ],
  },
  {
          ...
          {[
            ...
            <div key={label} className="rounded-xl p-2 text-center" style={{ backgroundColor: "#1a1a1a" }}>
              ...
              <div className="text-sm font-bold" style={{
                color: label === "KH"
                  ? (wert <= 5 ? "#22c55e" : wert <= 10 ? "#f59e0b" : "#ef4444")
                  : "#fff"
              }}>
                {wert}{einheit}
              </div>
  ...
  return (
    <main className="px-4 py-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {gefiltert.length === 0 && (
          <div className="col-span-2 text-center py-8" style={{ color: "#555" }}>
