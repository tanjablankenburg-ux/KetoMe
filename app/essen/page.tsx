...
const DB: DBItem[] = [
  ...
  // ── SAUCEN & WÜRZEN ───────────────────────────────────────────────────────
  { name: "Senf (mittelscharf)", kcal: 82, kh: 6, eiweiss: 5, fett: 4, ballaststoffe: 1, einheit: "g" },
  { name: "Tomatenmark", kcal: 82, kh: 12, eiweiss: 4, fett: 0.4, ballaststoffe: 2.5, einheit: "g" },
  { name: "Sojasoße", kcal: 53, kh: 5, eiweiss: 8, fett: 0, ballaststoffe: 0, einheit: "ml", synonyme: ["sojasauce","tamari"] },
  { name: "Pesto (Basilikum)", kcal: 450, kh: 4, eiweiss: 5, fett: 46, ballaststoffe: 1, einheit: "g" },
  // ── PROTEINPRODUKTE ───────────────────────────────────────────────────────
